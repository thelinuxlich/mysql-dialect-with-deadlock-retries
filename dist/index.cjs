...
var retryx = require('@harisk/retryx');
...
class MySQLDialectWithDeadlockRetries {
  ...
  createQueryCompiler() {
    return new kysely.MysqlQueryCompiler();
  }
  createAdapter() {
    return new kysely.MysqlAdapter();
  }
  // biome-ignore lint/suspicious/noExplicitAny: <explanation>
  createIntrospector(db) {
    return new kysely.MysqlIntrospector(db);
  }
}
_config3 = new WeakMap();

exports.MySQLDialectWithDeadlockRetries = MySQLDialectWithDeadlockRetries;
